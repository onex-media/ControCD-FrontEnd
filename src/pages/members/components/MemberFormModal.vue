          ...
          <q-tab-panel name="personal">
            <div class="row q-col-gutter-sm" v-if="memberForm">
              ...
              <div class="col-12 col-md-6">
                ...
                <q-input
                  v-model="memberForm.identification"
                  outlined
                  dense
                  maxlength="10"
                  class="mt-1"
              ...
              <div class="col-12 col-md-6">
                ...
                <q-select
                  ...
                  :error="v$.form.city_id.$invalid && v$.form.city_id.$dirty"
                  @blur="v$.form.city_id.$touch"
                >
                  <template
                    v-slot:error
                    v-if="v$.form.city_id.$invalid && v$.form.city_id.$dirty"
                  >
              ...
              <div class="col-12 col-md-6">
                ...
                <q-input
                  ...
                  :error="v$.form.address.$invalid && v$.form.address.$dirty"
              ...
              <div class="col-12 col-md-6">
                ...
                <q-select
                  ...
                  behavior="menu"
                  class="mt-1"
                  :error="v$.form.role_id.$invalid && v$.form.role_id.$dirty"
...
const emit = defineEmits(["update:modelValue", "save-member", "close-modal"]);
